...
import com.caiwei.object.annotation.AuthCheck;
import com.caiwei.object.common.BaseResponse;
import com.caiwei.object.common.DeleteRequest;
import com.caiwei.object.common.ErrorCode;
import com.caiwei.object.common.ResultUtils;
import com.caiwei.object.constant.UserConstant;
import com.caiwei.object.exception.BusinessException;
import com.caiwei.object.exception.ThrowUtils;
import com.caiwei.object.model.dto.scoringResult.ScoringResultAddRequest;
import com.caiwei.object.model.dto.scoringResult.ScoringResultEditRequest;
import com.caiwei.object.model.dto.scoringResult.ScoringResultQueryRequest;
import com.caiwei.object.model.dto.scoringResult.ScoringResultUpdateRequest;
import com.caiwei.object.model.entity.ScoringResult;
import com.caiwei.object.model.entity.User;
import com.caiwei.object.model.vo.ScoringResultVO;
...
public class ScoringResultController {
    ...
    public BaseResponse<Long> addScoringResult(@RequestBody ScoringResultAddRequest scoringResultAddRequest, HttpServletRequest request) {
        ...
        List<String> resultPropList = scoringResultAddRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(resultPropList));
        // 数据校验
    ...
    public BaseResponse<Boolean> updateScoringResult(@RequestBody ScoringResultUpdateRequest scoringResultUpdateRequest) {
        ...
        List<String> resultPropList = scoringResultUpdateRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(resultPropList));
    ...
    public BaseResponse<Boolean> editScoringResult(@RequestBody ScoringResultEditRequest scoringResultEditRequest, HttpServletRequest request) {
        ...
        scoringResultService.validScoringResult(scoringResult, false);
        User loginUser = userService.getLoginUser(request);
        List<String> resultPropList = scoringResultEditRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(resultPropList));
        // 判断是否存在
