...
import com.caiwei.object.constant.CommonConstant;
import com.caiwei.object.exception.ThrowUtils;
import com.caiwei.object.mapper.AppMapper;
import com.caiwei.object.model.dto.app.AppQueryRequest;
...
import com.caiwei.object.model.vo.AppVO;
import com.caiwei.object.model.vo.UserVO;
import com.caiwei.object.service.AppService;
import com.caiwei.object.service.UserService;
import com.caiwei.object.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            AppScoringStategyEnum appScoringStategyEnum = AppScoringStategyEnum.getEnumByValue(scoringStrategy);
            ThrowUtils.throwIf(appScoringStategyEnum == null, ErrorCode.PARAMS_ERROR, "评分策略不能为空");
        }
        // 修改数据时，有参数则校验
        // 校验规则
